...
# DONE: define the 'EXPECTED_BAKE_TIME' constant below.
...
def preparation_time_in_minutes(layers):
    ...
    it took to prepare the lasagna based on the `PREPARATION_TIME`.
    """
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    and returns the total elapsed time based on the `PREPARATION_TIME` and `EXPECTED_BAKE_TIME`.
    """
